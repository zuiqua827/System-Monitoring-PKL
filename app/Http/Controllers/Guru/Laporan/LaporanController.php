...
class LaporanController extends Controller
{
    ...
    public function siswa(Request $request): View
    {
        ...
        $penempatanPkls = $this->laporanService->getGuruSummary($user->guru->id, $filters);
        ...
        return view('guru.laporan.siswa', compact('penempatanPkls', 'periodes', 'jurusans', 'kelass', 'guru'));
    }
    ...
    public function absensi(Request $request): View
    {
        ...
        $report = $this->laporanService->getGuruAbsensiReport($user->guru->id, $filters);
        ...
        return view('guru.laporan.absensi', compact('absensis', 'stats', 'periodes', 'jurusans', 'kelass', 'guru'));
    }
    ...
    public function aktivitas(Request $request): View
    {
        ...
        $report = $this->laporanService->getGuruAktivitasReport($user->guru->id, $filters);
        ...
        return view('guru.laporan.aktivitas', compact('aktivitas', 'stats', 'periodes', 'jurusans', 'kelass', 'guru'));
    }
    ...
    public function penilaian(Request $request): View
    {
        ...
        $report = $this->laporanService->getGuruPenilaianReport($user->guru->id, $filters);
        ...
        return view('guru.laporan.penilaian', compact('penilaian', 'stats', 'periodes', 'jurusans', 'kelass', 'guru'));
    }
    ...
    public function exportSiswaExcel(Request $request)
    {
        ...
        $query = $this->laporanService->getGuruSiswaExportQuery($user->guru->id, $filters);
    ...
    public function exportSiswaPdf(Request $request)
    {
        ...
        $report = $this->laporanService->getGuruSiswaPdfReport($user->guru->id, $filters);
    ...
    public function exportAbsensiExcel(Request $request)
    {
        ...
        $export = $this->laporanService->getGuruAbsensiExport($user->guru->id, $filters);
