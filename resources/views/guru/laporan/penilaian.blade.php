        ...
        <div class="mb-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-card-sm">
            <form action="{{ route('guru.laporan.penilaian') }}" method="GET">
                ...
                <div class="mt-4 flex justify-end gap-3">
                    <a href="{{ route('guru.laporan.penilaian') }}" class="rounded-xl border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-600 transition hover:bg-slate-50">Reset</a>
