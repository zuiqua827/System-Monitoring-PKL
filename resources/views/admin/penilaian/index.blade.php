                                    ...
                                    <div class="flex items-center justify-center gap-1">
                                        ...
                                        @unless($penilaian->trashed())
                                            ...
                                            @can('delete', $penilaian)
                                                <form method="POST" action="{{ route('admin.penilaian.destroy', $penilaian->id) }}" class="inline" onsubmit="return confirm('Hapus penilaian ini?')">
                                                    @csrf
                                                    @method('DELETE')
                                        ...
                                        @else
                                            @can('restore', $penilaian)
                                                <form method="POST" action="{{ route('admin.penilaian.restore', $penilaian->id) }}" class="inline" onsubmit="return confirm('Pulihkan penilaian ini?')">
                                                    @csrf
                                            ...
                                            @can('forceDelete', $penilaian)
                                                <form method="POST" action="{{ route('admin.penilaian.force-delete', $penilaian->id) }}" class="inline" onsubmit="return confirm('Hapus permanen penilaian ini?')">
                                                    @csrf
                                                    @method('DELETE')
