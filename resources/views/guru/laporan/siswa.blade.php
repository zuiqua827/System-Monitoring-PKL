...
@section('title', 'Laporan Siswa Bimbingan')
    ...
    <div class="mx-auto max-w-7xl">
        <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <h1 class="mt-2 text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">Siswa & Penempatan Bimbingan</h1>
            </div>
            <div class="flex flex-wrap items-center gap-3">
                <a href="{{ route('guru.laporan.siswa.export.excel', request()->query()) }}" class="flex items-center gap-2 rounded-xl bg-green-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-green-700">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    Export Excel
                </a>
                <a href="{{ route('guru.laporan.siswa.export.pdf', request()->query()) }}" class="flex items-center gap-2 rounded-xl bg-red-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-red-700">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="mb-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-card-sm">
            <form action="{{ route('guru.laporan.siswa') }}" method="GET">
                <div class="grid gap-4 sm:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                    <div>
                ...
                <div class="mt-4 flex justify-end gap-3">
                    <a href="{{ route('guru.laporan.siswa') }}" class="rounded-xl border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-600 transition hover:bg-slate-50">Reset</a>
