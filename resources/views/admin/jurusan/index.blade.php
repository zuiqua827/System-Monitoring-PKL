                                ...
                                <td class="px-4 py-3.5">
                                    <div class="flex items-center justify-center gap-1">
                                        ...
                                        @unless($jurusan->trashed())
                                            ...
                                            @can('delete', $jurusan)
                                                <form method="POST" action="{{ route('admin.jurusan.destroy', $jurusan->id) }}" class="inline"
                                        ...
                                        @else
                                            @can('restore', $jurusan)
                                                <form method="POST" action="{{ route('admin.jurusan.restore', $jurusan->id) }}" class="inline"
                                            ...
                                            @can('forceDelete', $jurusan)
                                                <form method="POST" action="{{ route('admin.jurusan.force-delete', $jurusan->id) }}" class="inline"
