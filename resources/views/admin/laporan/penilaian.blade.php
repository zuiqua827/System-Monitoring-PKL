    ...
    <div class="mx-auto max-w-7xl">
        <div class="mb-8 flex items-center justify-between">
            <div>
                ...
                <h1 class="mt-2 text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">Penilaian Siswa PKL</h1>
            </div>
            ...
            <form action="{{ route('admin.laporan.penilaian') }}" method="GET">
                <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    ...
                    <div>
                        ...
                        <select name="guru_id" id="guru_id" class="mt-1 block w-full rounded-xl border-slate-200 text-sm focus:border-orange-500 focus:ring-orange-500">
                    ...
                    <div>
                        ...
                        <select name="dudi_id" id="dudi_id" class="mt-1 block w-full rounded-xl border-slate-200 text-sm focus:border-orange-500 focus:ring-orange-500">
                ...
                <div class="mt-4 flex justify-end gap-3">
                    <a href="{{ route('admin.laporan.penilaian') }}" class="rounded-xl border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-600 transition hover:bg-slate-50">Reset</a>
