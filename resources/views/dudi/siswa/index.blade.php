...
<div class="px-4 py-4 sm:px-6 sm:py-8 lg:px-8">
    <div class="mx-auto max-w-7xl space-y-6">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-card-sm">
            <form method="GET" action="{{ route('dudi.siswa.index') }}" class="flex flex-col gap-3 sm:flex-row sm:items-center flex-wrap">
                <div class="flex-1">
                    <div class="relative">
                ...
                <div class="w-full sm:w-48">
                    <select name="status" class="block w-full rounded-xl border border-slate-200 bg-white py-2.5 px-3 text-sm text-slate-900 shadow-sm transition focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200">
