        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-end">
                ...
                @unless($jurusan->trashed())
                    ...
                    @endcan
                    @can('delete', $jurusan)
                        <form method="POST" action="{{ route('admin.jurusan.destroy', $jurusan->id) }}" onsubmit="return confirm('Hapus jurusan {{ $jurusan->nama }}?')">
                            @csrf
                            @method('DELETE')
                ...
                @else
                    @can('restore', $jurusan)
                        <form method="POST" action="{{ route('admin.jurusan.restore', $jurusan->id) }}" onsubmit="return confirm('Pulihkan jurusan {{ $jurusan->nama }}?')">
                            @csrf
                    ...
                    @can('forceDelete', $jurusan)
                        <form method="POST" action="{{ route('admin.jurusan.force-delete', $jurusan->id) }}" onsubmit="return confirm('Hapus permanen {{ $jurusan->nama }}? Tindakan ini tidak dapat dibatalkan!')">
                            @csrf
                            @method('DELETE')
