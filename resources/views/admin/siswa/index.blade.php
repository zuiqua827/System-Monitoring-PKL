                                ...
                                <td class="px-4 py-3.5">
                                    <div class="flex items-center justify-center gap-1">
                                        ...
                                        @unless($siswa->trashed())
                                            ...
                                            @can('delete', $siswa)
                                                <form method="POST" action="{{ route('admin.siswa.destroy', $siswa->id) }}" class="inline"
                                        ...
                                        @else
                                            @can('restore', $siswa)
                                                <form method="POST" action="{{ route('admin.siswa.restore', $siswa->id) }}" class="inline"
                                            ...
                                            @can('forceDelete', $siswa)
                                                <form method="POST" action="{{ route('admin.siswa.force-delete', $siswa->id) }}" class="inline"
