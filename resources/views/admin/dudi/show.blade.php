        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-end">
                ...
                @unless($dudi->trashed())
                    ...
                    @endcan
                    @can('delete', $dudi)
                        <form method="POST" action="{{ route('admin.dudi.destroy', $dudi->id) }}"
                ...
                @else
                    @can('restore', $dudi)
                        <form method="POST" action="{{ route('admin.dudi.restore', $dudi->id) }}"
                    ...
                    @can('forceDelete', $dudi)
                        <form method="POST" action="{{ route('admin.dudi.force-delete', $dudi->id) }}"
